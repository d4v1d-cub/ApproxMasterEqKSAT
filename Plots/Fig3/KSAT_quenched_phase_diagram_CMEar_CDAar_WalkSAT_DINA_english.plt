...
filenameoutput="CMEar_CDAar_DINA_WalkSAT_KSAT_quenched_phase_diagram_english.eps"
...
, 'CDA_av_rates_K_3_PD.txt' u (($2 + $3)/2):1:2:3 w xerror ps 1.1 pt 4 lc 2 lw 3 title "{/=26 CDA" \
, 'WalkSAT_PD_convexity.txt' u (($2 + $3)/2):1 w l lc 8 lw 2 dt 2 notitle \
