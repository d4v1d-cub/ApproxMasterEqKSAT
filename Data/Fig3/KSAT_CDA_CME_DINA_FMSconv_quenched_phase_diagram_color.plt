...
filenameoutput="CDA_CME_DINA_FMSconv_phase_diagram_color.eps"
...
, 'Weigt_eqs.txt' u 2:1:($2-$3):($2+$4) w xerrorbars ps 1.4 pt 12 lc 7 lw 4 title "{/=28 DINA" \
, 'Weigt_eqs.txt' u 2:1 w l lc 7 lw 2 dt 2 notitle \
, 'CDA_transition_FMS_N_1000.txt' u 2:1:($2-$3):($2+$4) w xerrorbars ps 1.1 pt 4 lc 2 lw 3 title "{/=26 CDA" \
